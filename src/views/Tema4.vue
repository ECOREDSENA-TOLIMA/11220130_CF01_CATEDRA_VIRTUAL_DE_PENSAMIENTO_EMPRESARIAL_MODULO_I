...
.curso-main-container.pb-3
  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5.mb-5
    ...
    .row.justify-content-center.align-items-center.mb-5
      ...
      .col-lg-6
        p En consecuencia, el proyecto de vida es el medio que le permite a una persona establecer mediante una secuencia de planes el camino para alcanzar lo que quiere llegar a ser en un determinado plazo de tiempo.
